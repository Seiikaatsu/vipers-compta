<!DOCTYPE html>
    ...
    <title>Vipers Compta - Inscription</title>
    ...
    <a href="http://vipers-gtarp.fr">
        <img class="vipers-image" src="img/Vipers%20PNG.png" alt="Vipers Image" style="width: 200px; height: auto; margin: 0 auto;">
    </a>
</div>

 
                <div class="form-group">
                    <input type="text" name="pseudo" class="form-control" placeholder="Nom RolePlay" required="required" autocomplete="off">
                </div>
                <div class="form-group">
